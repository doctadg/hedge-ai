...
const settings = [
  {
    ...
    items: [
      ...
      { name: "Security Settings", description: "Manage your password and security options" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Display Settings", description: "Customize your dashboard appearance" },
  ...
  },
  {
    ...
    items: [
      { name: "Exchange Connections", description: "Manage your exchange API connections" },
          ...
          <Card key={section.category} className="bg-[#0A0A0A] border-[#1a1a1a]">
            ...
            <CardContent className="space-y-4">
              {section.items.map((item) => (
                <div key={item.name} className="flex items-center justify-between p-4 rounded-lg bg-[#1a1a1a]">
                  <div>
